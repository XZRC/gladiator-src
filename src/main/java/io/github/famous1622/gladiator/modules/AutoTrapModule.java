...
public class AutoTrapModule extends Module {
    public final Value<Cage> mode = new Value<>("Mode", new String[]{"Mode", "M"}, "The brightness mode to use.", Cage.TRAP);
    ...
    public AutoTrapModule() {
        super("AutoTrap", new String[]{"AT"}, "Traps niggas in obsidian", "NONE", -1, ModuleType.COMBAT);
    }
    ...
    private boolean placeBlockInRange(BlockPos pos, double range) {
        ...
        int obiSlot = InventoryUtil.getItemHotbar(Item.getItemFromBlock(Blocks.OBSIDIAN));
