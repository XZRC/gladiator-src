...
public class EventRenderFluid extends EventCancellable {
    ...
    public EventRenderFluid(IBlockAccess blockAccess, IBlockState blockStateIn, BlockPos blockPosIn, BufferBuilder bufferBuilderIn) {
        this.blockAccess = blockAccess;
        this.blockState = blockStateIn;
        this.blockPos = blockPosIn;
        this.bufferBuilder = bufferBuilderIn;
    }
