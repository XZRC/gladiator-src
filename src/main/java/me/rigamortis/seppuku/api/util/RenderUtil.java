...
//        GlStateManager.popMatrix();
    ...
    public static void drawLine3D(float x, float y, float z, float x1, float y1, float z1, float thickness, int hex) {
        ...
        KamiTessellator.prepare(GL_LINE_STRIP);
        glLineWidth(thickness);
        glEnable(GL_LINE_SMOOTH);
        glHint(GL_LINE_SMOOTH_HINT, GL_NICEST);
        BufferBuilder buffer = KamiTessellator.getBufferBuilder();
...
//        GlStateManager.popMatrix();
    ...
    public static void drawBoundingBox(AxisAlignedBB bb, float width, float red, float green, float blue, float alpha) {
        ...
        glHint(GL_LINE_SMOOTH_HINT, GL_NICEST);
        GlStateManager.disableBlend();
        KamiTessellator.drawLines(KamiTessellator.getBufferBuilder(),(float)bb.minX, (float)bb.minY, (float)bb.minZ, (float)(bb.maxX - bb.minX), (float)(bb.maxY-bb.minY), (float)(bb.maxZ-bb.minZ), (int)red*255, (int)green*255,(int)blue*255, (int)alpha*255, KamiTessellator.GeometryMasks.Line.ALL);
        KamiTessellator.release();
        GlStateManager.enableBlend();
        glDisable(GL_LINE_SMOOTH);
...
//        GlStateManager.popMatrix();
    ...
    public static void drawFilledBox(AxisAlignedBB bb, int color) {
        ...
        final BufferBuilder bufferbuilder = KamiTessellator.getBufferBuilder();
