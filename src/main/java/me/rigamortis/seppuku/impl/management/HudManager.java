...
import org.drink.piss.Hud.DurabilityComponent;
import org.drink.piss.Hud.LocalDifficultyComponent;
...
public final class HudManager {
    ...
    public HudManager() {
        ...
        this.componentList.add(new XPCountComponent());
        this.componentList.add(new GappleCountComponent());
        ...
        this.componentList.add(new HelloComponent());
        this.componentList.add(new DurabilityComponent());
        this.componentList.add(new LocalDifficultyComponent());
        this.componentList.add(new CrystalCountComponent());
