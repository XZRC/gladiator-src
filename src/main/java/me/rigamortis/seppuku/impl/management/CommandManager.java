...
import io.github.famous1622.gladiator.commands.*;
...
import org.drink.piss.Commands.TrueDurabilityCommand;
...
public final class CommandManager {
    ...
    public CommandManager() {
        ...
        this.commandList.add(new RelogCommand());
        ...
        this.commandList.add(new FakeWBCommand());
        this.commandList.add(new FindEntityCommand());
        this.commandList.add(new MobOwnerCommand());
        this.commandList.add(new CalcStrongholdCommand());
        this.commandList.add(new ElytraHClipCommand());
        this.commandList.add(new TrueDurabilityCommand());
        this.commandList.add(new DropAllCommand());
        this.commandList.add(new PacketHClipCommand());
        this.commandList.add(new SoftLeaveModule());
        this.commandList.add(new OhGodOhFuckCommand());
        this.commandList.add(new DumpNBTCommand());
        this.commandList.add(new JJPlzCommand());
