...
//                                GL11.glEnable(GL11.GL_BLEND);
                                ...
                                Seppuku.INSTANCE.getFontManager().drawString(name, bounds[0] + (bounds[2] - bounds[0]) / 2 - Seppuku.INSTANCE.getFontManager().getStringWidth(name) / 2, bounds[1] + (bounds[3] - bounds[1]) - Seppuku.INSTANCE.getFontManager().getHeight() - 1, ColorUtil.changeAlpha(0xFFFFFFFF, this.opacity.getValue()), true, false);
