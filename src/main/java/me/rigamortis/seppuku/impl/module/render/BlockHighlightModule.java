    ...
    public void render3D(EventRender3D event) {
        ...
        if(ray.typeOfHit == RayTraceResult.Type.BLOCK) {
            ...
            if (iblockstate.getMaterial() != Material.AIR && mc.world.getWorldBorder().contains(blockpos)) {
                ...
                RenderUtil.drawFilledBox(iblockstate.getSelectedBoundingBox(mc.world, blockpos).grow(0.0020000000949949026D).offset(-interp.x, -interp.y, -interp.z), ColorUtil.changeAlpha(0xFF9900EE, opacity.getValue()));
            }
        }
    }
