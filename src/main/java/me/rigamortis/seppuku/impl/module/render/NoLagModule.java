...
public final class NoLagModule extends Module {
    ...
    public final Value<Boolean> vines = new Value<Boolean>("Vines", new String[]{"Vine"}, "Choose to enable the vine lag fix. Disables vines from rendering.", false);
