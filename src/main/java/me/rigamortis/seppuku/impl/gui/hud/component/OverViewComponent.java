...
public final class OverViewComponent extends ResizableHudComponent {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        if (inside)
            Seppuku.INSTANCE.getFontManager().drawString("Zoom: " + this.distance, this.getX() + 4, this.getY() + this.getH() - Seppuku.INSTANCE.getFontManager().getHeight() - 2, 0xFFFFFFFF, true, false);
    }
