...
public final class Seppuku {
    ...
    public void init() {
        ...
        Display.setTitle("Gladiator 1.12.2");

        this.getEventManager().dispatchEvent(new EventLoad());

        new ClickGUI();
        ClickGUI.getInstance().setWindows(
                Windows.windowCombat,
                Windows.windowMovement,
                Windows.windowOther,
                Windows.windowPlayer,
                Windows.windowRender,
                Windows.windowWorld,
                Windows.windowExploit,
                Windows.windowChat
        );
    ...
    public void errorChat(String message) {
        Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(new TextComponentString("\2477[Gladiator]\247c " + message));
    }
    ...
    public void logChat(String message) {
        Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(new TextComponentString("\2477[Gladiator]\247f " + message));
    }

    public void logcChat(ITextComponent textComponent) {
        Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(new TextComponentString("\2477[Gladiator]\247f ").appendSibling(textComponent));
    }
    ...
    public FontManager getFontManager() {
     ...
     public static <E> E dispatchEvent(E event) {
        return INSTANCE.getEventManager().dispatchEvent(event);
     }
}
